    ...
    def plot_multiple(self,results):
        ...
        for dataset in datasets:
            ...
            for experiment,result in results.items():
                ...
                color_index+=1
                plt.legend(title='Usage per nb of clusters')
                plt.show()

            plt.savefig("./results/fig/experiments_"+dataset+".png")
...
if __name__=='__main__':
    ...
    if experiment:
        ...
        for pipeline in pipelines:
            ...
            ucdce=UCDCExperiment(name_experiment)
            ucdce.experiment(clustering_pip(),sample_heuri())
            results_path.append((name_experiment,ucdce.result_path))
    
    if plot:
        
        # results_path=[("NoClusteringOnlySampling",'./results/json/resultsNoClusteringOnlySampling.json'), ("KmeansWithSampling",'./results/json/resultsKmeansWithSampling.json'), ("KmeansWithBestUsageChoice",'./results/json/resultsKmeansWithBestUsageChoice.json')]
        results={}
